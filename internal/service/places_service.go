...
var placeholderPlaces = []model.PlaceResult{
	// tourist_attraction
	{ID: "placeholder_ta_1", Name: "Notre-Dame Cathedral Basilica", Lat: 10.7797, Lng: 106.6990, Type: "tourist_attraction", Rating: floatPtr(4.6), ReviewCount: intPtr(12480), Description: "Iconic 19th-century French colonial cathedral in the heart of the city.", Address: "Công xã Paris, Bến Nghé, Quận 1, TP.HCM", Hours: "8AM – 5PM", OpenNow: boolPtr(true), Distance: "0.4 km"},
	{ID: "placeholder_ta_2", Name: "Reunification Palace", Lat: 10.7771, Lng: 106.6956, Type: "tourist_attraction", Rating: floatPtr(4.5), ReviewCount: intPtr(9320), Description: "Historic presidential palace where the Vietnam War officially ended in 1975.", Address: "135 Nam Kỳ Khởi Nghĩa, Bến Thành, Quận 1, TP.HCM", Hours: "7:30AM – 5PM", OpenNow: boolPtr(true), Distance: "0.8 km"},
	{ID: "placeholder_ta_3", Name: "War Remnants Museum", Lat: 10.7794, Lng: 106.6919, Type: "tourist_attraction", Rating: floatPtr(4.7), ReviewCount: intPtr(21050), Description: "Powerful museum documenting the Vietnam War through photographs and artefacts.", Address: "28 Võ Văn Tần, Phường 6, Quận 3, TP.HCM", Hours: "7:30AM – 6PM", OpenNow: boolPtr(true), Distance: "1.2 km"},
	{ID: "placeholder_ta_4", Name: "Ben Thanh Market", Lat: 10.7721, Lng: 106.6981, Type: "tourist_attraction", Rating: floatPtr(4.2), ReviewCount: intPtr(34100), Description: "Bustling landmark market selling street food, souvenirs, and local goods.", Address: "Lê Lợi, Bến Thành, Quận 1, TP.HCM", Hours: "6AM – 6PM", OpenNow: boolPtr(true), Distance: "0.6 km"},
	{ID: "placeholder_ta_5", Name: "Saigon Central Post Office", Lat: 10.7798, Lng: 106.6998, Type: "tourist_attraction", Rating: floatPtr(4.5), ReviewCount: intPtr(8760), Description: "Stunning French colonial post office designed by Gustave Eiffel.", Address: "2 Công xã Paris, Bến Nghé, Quận 1, TP.HCM", Hours: "7AM – 7PM", OpenNow: boolPtr(true), Distance: "0.5 km"},

	// restaurant
	{ID: "placeholder_rs_1", Name: "Pho 24", Lat: 10.7749, Lng: 106.7019, Type: "restaurant", Rating: floatPtr(4.3), ReviewCount: intPtr(5640), PriceLevel: "$", Description: "Popular chain serving classic Vietnamese pho in a clean, air-conditioned setting.", Address: "5 Nguyễn Thiệp, Bến Nghé, Quận 1, TP.HCM", Hours: "6AM – 10PM", OpenNow: boolPtr(true), Distance: "0.3 km"},
	{ID: "placeholder_rs_2", Name: "The Deck Saigon", Lat: 10.8031, Lng: 106.7305, Type: "restaurant", Rating: floatPtr(4.5), ReviewCount: intPtr(2890), PriceLevel: "$$$", Description: "Riverside restaurant with stunning views and an eclectic international menu.", Address: "38 Nguyễn U Dĩ, Thảo Điền, Quận 2, TP.HCM", Hours: "11AM – 11PM", OpenNow: boolPtr(true), Distance: "4.1 km"},
	{ID: "placeholder_rs_3", Name: "Cục Gạch Quán", Lat: 10.7839, Lng: 106.6945, Type: "restaurant", Rating: floatPtr(4.6), ReviewCount: intPtr(4120), PriceLevel: "$$", Description: "Charming heritage house restaurant serving authentic Vietnamese home-cooking.", Address: "10 Đặng Tất, Tân Định, Quận 1, TP.HCM", Hours: "11AM – 10PM", OpenNow: boolPtr(true), Distance: "1.5 km"},
	{ID: "placeholder_rs_4", Name: "Nhà Hàng Ngon", Lat: 10.7779, Lng: 106.6939, Type: "restaurant", Rating: floatPtr(4.4), ReviewCount: intPtr(7830), PriceLevel: "$$", Description: "Garden restaurant with live street-food stalls covering every Vietnamese region.", Address: "160 Pasteur, Bến Nghé, Quận 1, TP.HCM", Hours: "7AM – 10PM", OpenNow: boolPtr(true), Distance: "0.9 km"},
	{ID: "placeholder_rs_5", Name: "Bun Bo Hue An Nam", Lat: 10.7701, Lng: 106.6935, Type: "restaurant", Rating: floatPtr(4.4), ReviewCount: intPtr(3210), PriceLevel: "$", Description: "Beloved local spot for spicy Hue-style beef noodle soup.", Address: "14 Tôn Thất Tùng, Phạm Ngũ Lão, Quận 1, TP.HCM", Hours: "6AM – 2PM", OpenNow: boolPtr(false), Distance: "1.1 km"},

	// amusement_park
	{ID: "placeholder_ap_1", Name: "Dam Sen Water Park", Lat: 10.7554, Lng: 106.6472, Type: "amusement_park", Rating: floatPtr(4.1), ReviewCount: intPtr(18200), PriceLevel: "$$", Description: "Large water park with slides, wave pools, and family attractions.", Address: "3 Hòa Bình, Phường 3, Quận 11, TP.HCM", Hours: "8AM – 6PM", OpenNow: boolPtr(true), Distance: "5.8 km"},
	{ID: "placeholder_ap_2", Name: "Suoi Tien Theme Park", Lat: 10.8623, Lng: 106.8337, Type: "amusement_park", Rating: floatPtr(4.0), ReviewCount: intPtr(22400), PriceLevel: "$$", Description: "Vast cultural theme park blending Vietnamese folklore with rides and water attractions.", Address: "Xa lộ Hà Nội, Hiệp Phú, Quận 9, TP.HCM", Hours: "8AM – 6PM", OpenNow: boolPtr(true), Distance: "14.2 km"},
	{ID: "placeholder_ap_3", Name: "VinKE Times City", Lat: 10.7735, Lng: 106.6593, Type: "amusement_park", Rating: floatPtr(4.3), ReviewCount: intPtr(6700), PriceLevel: "$$$", Description: "Indoor entertainment complex with interactive science exhibits for children.", Address: "458 Minh Khai, Quận 11, TP.HCM", Hours: "9AM – 9PM", OpenNow: boolPtr(true), Distance: "3.5 km"},

	// bar
	{ID: "placeholder_br_1", Name: "Chill Skybar", Lat: 10.7748, Lng: 106.7028, Type: "bar", Rating: floatPtr(4.3), ReviewCount: intPtr(6540), PriceLevel: "$$$", Description: "Rooftop bar on the 26th floor with panoramic city views and craft cocktails.", Address: "AB Tower, 76A Lê Lai, Bến Thành, Quận 1, TP.HCM", Hours: "5PM – 2AM", OpenNow: boolPtr(true), Distance: "0.4 km"},
	{ID: "placeholder_br_2", Name: "The Observatory", Lat: 10.7679, Lng: 106.6971, Type: "bar", Rating: floatPtr(4.5), ReviewCount: intPtr(3120), PriceLevel: "$$", Description: "Intimate craft beer and cocktail bar with a curated vinyl music experience.", Address: "5 Nguyễn Siêu, Bến Nghé, Quận 1, TP.HCM", Hours: "6PM – 2AM", OpenNow: boolPtr(false), Distance: "1.4 km"},
	{ID: "placeholder_br_3", Name: "EON Heli Bar", Lat: 10.7729, Lng: 106.7034, Type: "bar", Rating: floatPtr(4.4), ReviewCount: intPtr(4880), PriceLevel: "$$$", Description: "Upscale helipad bar atop the Bitexco Tower with 360° views of the city.", Address: "2 Hải Triều, Bến Nghé, Quận 1, TP.HCM", Hours: "11AM – 1AM", OpenNow: boolPtr(true), Distance: "0.7 km"},
	{ID: "placeholder_br_4", Name: "Pasteur Street Brewing Co.", Lat: 10.7771, Lng: 106.6981, Type: "bar", Rating: floatPtr(4.5), ReviewCount: intPtr(5980), PriceLevel: "$$", Description: "Pioneer craft brewery offering bold Vietnamese-ingredient beers on tap.", Address: "144 Pasteur, Bến Nghé, Quận 1, TP.HCM", Hours: "11AM – 11:30PM", OpenNow: boolPtr(true), Distance: "0.9 km"},

	// lodging
	{ID: "placeholder_lg_1", Name: "Park Hyatt Saigon", Lat: 10.7772, Lng: 106.7025, Type: "lodging", Rating: floatPtr(4.8), ReviewCount: intPtr(4230), PriceLevel: "$$$$", PricePerNight: "$320/night", Description: "Elegant colonial-style luxury hotel on Lam Son Square with world-class dining.", Address: "2 Lam Sơn Square, Bến Nghé, Quận 1, TP.HCM", Hours: "Open 24 hours", OpenNow: boolPtr(true), Distance: "0.5 km"},
	{ID: "placeholder_lg_2", Name: "The Myst Dong Khoi", Lat: 10.7783, Lng: 106.7011, Type: "lodging", Rating: floatPtr(4.6), ReviewCount: intPtr(2870), PriceLevel: "$$$", PricePerNight: "$150/night", Description: "Boutique heritage hotel housed in a restored 1930s French colonial building.", Address: "6-8 Hồ Huấn Nghiệp, Bến Nghé, Quận 1, TP.HCM", Hours: "Open 24 hours", OpenNow: boolPtr(true), Distance: "0.6 km"},
	{ID: "placeholder_lg_3", Name: "Caravelle Saigon", Lat: 10.7762, Lng: 106.7020, Type: "lodging", Rating: floatPtr(4.7), ReviewCount: intPtr(5610), PriceLevel: "$$$$", PricePerNight: "$210/night", Description: "Iconic 5-star hotel with a rich history and the legendary Saigon Saigon Rooftop Bar.", Address: "19-23 Lam Sơn Square, Bến Nghé, Quận 1, TP.HCM", Hours: "Open 24 hours", OpenNow: boolPtr(true), Distance: "0.4 km"},
	{ID: "placeholder_lg_4", Name: "Bui Vien Boutique Hostel", Lat: 10.7669, Lng: 106.6937, Type: "lodging", Rating: floatPtr(4.3), ReviewCount: intPtr(1890), PriceLevel: "$", PricePerNight: "$18/night", Description: "Lively backpacker hostel in the heart of the Bui Vien walking street area.", Address: "245 Đề Thám, Phạm Ngũ Lão, Quận 1, TP.HCM", Hours: "Open 24 hours", OpenNow: boolPtr(true), Distance: "1.8 km"},
}
